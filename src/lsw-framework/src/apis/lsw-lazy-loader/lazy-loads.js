(function (factory) {
  ...
  LswLazyLoader.global.register({
    alias: "flowsql-browser",
    url: "assets/lib/flowsql/flowsql-browser.js",
    type: "scriptSrc",
    once: true,
    confirmer: () => typeof FlowsqlBrowser !== "undefined",
  });
  ...
  class LswLazyLoads {
    ...
    static loadFlowsqlBrowser() {
      return LswLazyLoader.global.load("flowsql-browser");
    }
